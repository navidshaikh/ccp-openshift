...
if __name__ == "__main__":
    ir = IndexReader(sys.argv[1], sys.argv[2])
    projects = ir.read_projects()
    for project in projects:
        print project.dependson
        #print ("{}\t{}\t{}\t{}\t{}".format(project, project.dependson, project.build_context, project.pre_build_context, project.pre_build_script))

    print "project, dependson, build_context, prebuild_context, prebuild_script"
